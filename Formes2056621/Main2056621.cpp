...
#include "Fonctions2056621.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus et de dessiner différentes formes, pleines ou vides
using namespace std;
